      ...
      {cartItems.length === 0 ? (
        ...
        <>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <span className="text-sm sm:text-lg text-green-800 bg-green-300 p-1 rounded-md border-0 font-bold">${(item.price * item.quantity).toFixed(2)}
                  </span>
                </div>
          ...
          <div className="mt-4 flex justify-between items-center p-3 bg-slate-200 rounded-sm">
            ...
            <span className="bg-emerald-300 text-emerald-900 p-1 border-0 rounded-md font-bold">${total.toFixed(2)}</span>
          </div>
        </>
      )}
    </div>
